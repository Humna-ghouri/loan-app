...
//             validateStatus: (status) => status < 500 // Don't throw for 400/404
//           }
//         );
...
//     const input = document.getElementById('slip-container');
//     html2canvas(input).then((canvas) => {
//       const imgData = canvas.toDataURL('image/png');
//       const pdf = new jsPDF();
//       pdf.addImage(imgData, 'PNG', 0, 0);
//       pdf.save(`loan-slip-${loanDetails.tokenNumber || 'loan'}.pdf`);
//     });
//   };
...
//           <div id="slip-container" className="bg-white p-8 rounded-lg shadow-md">
//             {/* Header */}
...
//             {/* QR Code Section - Only show if exists */}
//             {loanDetails.qrCode && (
...
//             {/* Appointment Details - Show "Not specified" if missing */}
